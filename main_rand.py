...
if __name__ == '__main__':
    ...
    for ins in range(10):
        ...
        for it in range(10):
            ...
            c_set = np.arange(0,1,0.04)*max_c
            c_set[0] = 0.00001
            ...
            for i in range(len(c_set)):
                ...
                rst_wass_list[c] = x_seq = np.int32(np.round(sol['x_seq'])+1) 


            tft_det = out_sample.computeTotal2(n,test_data_p,test_data_p,S_test,x_seq_det)
            tft_saa = out_sample.computeTotal2(n,test_data_p,test_data_p,S_test,x_seq_saa)
            tft_wass = {}
            ...
            for i in range(len(c_set)):
                c = c_set[i]
                tft_wass[i] = out_sample.computeTotal2(n,test_data_p,test_data_p,S_test,rst_wass_list[c])
