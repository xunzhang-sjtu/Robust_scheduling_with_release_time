...
def set_para():
    ...
    para['delta_r'] = 0.15 # control ub of the release time
    para['delta_ep'] = 1 # control the upper bound of the mad
    para['delta_er'] = 1 # control the upper bound of the mad
    para['S_train'] = 10
    para['S_test'] = 10000
    para['iterations'] = 1
    para['instances'] = 10
    para['range_c'] = np.insert(np.arange(0.1,0.50001,0.1),0,np.arange(0,0.1,0.02))
